...
const Survey = () => {
  ...
  return (
    <div id="survey-page">
      <img
        id="survey-raccoon"
        src="./raccoon-washing.png"
        alt="Girl in a jacket"
        width="200"
        height="240"
      ></img>
      <img
        id="survey-raccoon-trash"
        src="./raccoon-trash.png"
        alt="Girl in a jacket"
        width="200"
        height="240"
      ></img>
      <h2>Please Rate the Following Chores</h2>

      <Form id="survey-form" onSubmit={handleFormSubmit}>
        <h4>Taking out the trash.</h4>
        <Form.Select
          name="trash"
          value={formState.trash}
        ...
        <h4>Washing the dishes.</h4>
        <Form.Select
          name="dishes"
          value={formState.dishes}
          onChange={handleChange}
          id="chore-2"
          aria-label="Default select example"
        >
